...
export default function Home() {
  const { data: _blogs } = swr('/api/blogs');
  const blogs = _blogs ? _blogs : null;

  return (
    <>
      <div className="py-20">
        <p className="text-3xl text-white font-semibold text-center">Referans Sunucularımız</p>
        <p className="text-xl text-white/50 font-normal text-center mb-5">Hizmet sağladığımız sunucular listesi.</p>
